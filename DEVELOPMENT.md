...
```bash
git remote add encore encore://campus-gram-mvp-ei9i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/campus-gram-mvp-ei9i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/campus-gram-mvp-ei9i/settings/integrations/github)
